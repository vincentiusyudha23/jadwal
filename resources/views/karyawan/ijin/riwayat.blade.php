...
@section('title', 'Riwayat Ijin Karyawan')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('karyawan.ijin.export') }}" class="btn btn-sm btn-success">Export</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="w-100 d-flex gap-2 justify-content-center align-items-center">
                                                <a href="{{ route('karyawan.ijin.details', $item->id) }}" class="btn btn-sm btn-success" type="button">
                                                    <i class="fa-solid fa-eye text-white"></i>
                                                </a>
                                                <x-button-delete table="datatable" :data_id="$item->id" :route="route('karyawan.ijin.delete')" method="POST"/>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
